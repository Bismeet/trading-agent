...
def create_research_manager(llm):
    ...
    def research_manager_node(state) -> dict:
        ...
        if len(history) > 12000:
            ...
            bull_snippet = bull_history[-5000:] if len(bull_history) > 5000 else bull_history
            bear_snippet = bear_history[-5000:] if len(bear_history) > 5000 else bear_history
            eval_history = (
                f"### Bull Thesis Summary (Core & Final Rebuttals):\n{bull_snippet}\n\n"
                f"### Bear Thesis Summary (Core & Final Rebuttals):\n{bear_snippet}"
            )
        else:
