...
# Meta Muse Spark models perform best on standard chat completions (plain LLM text generation),
# avoiding tool-choice HTTP 400s or gateway socket hangs.
_META_MUSE = ModelCapabilities(
    supports_tool_choice=False,
    supports_json_mode=False,
    supports_json_schema=False,
...
_BY_ID: dict[str, ModelCapabilities] = {
    ...
    "muse-spark-1.3-contributor": _META_MUSE,
    "muse-spark-1.3": _META_MUSE,
...
_BY_PATTERN: list[tuple[re.Pattern[str], ModelCapabilities]] = [
    ...
    (re.compile(r"^muse-spark"), _META_MUSE),
]
