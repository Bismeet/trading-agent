...
class OpenAIClient(BaseLLMClient):
    ...
    def get_llm(self) -> Any:
        ...
        if self.provider == "meta" and model_name.startswith("meta/"):
        ...
        # Default request timeout to avoid hanging sockets on unresponsive APIs (bumped to 180s for deep reasoning models)
        llm_kwargs.setdefault("request_timeout", 180.0)
