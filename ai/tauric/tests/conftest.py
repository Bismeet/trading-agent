...
# Ensure ai/tauric root is on sys.path for tradingagents, web, and cli imports
tauric_root = str(Path(__file__).resolve().parent.parent)
if tauric_root not in sys.path:
    sys.path.insert(0, tauric_root)
